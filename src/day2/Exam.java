...
public class Exam {
	public static void main(String[] args) {
		...
		questions[1] = new Question(2, "What is the size of float and double in java?", "32 & 64", "32 & 32", "64 & 64",
				"64 & 32", 'A');
		questions[2] = new Question(3, "Automatic type conversion is possible in which of the possible cases?",
				"Byte to int", "int to long", "long to int", "short to int", 'B');
		questions[3] = new Question(4, "Arrays in java are-", "Object references", "Objects", "Primitive data type",
				"none", 'B');
		questions[4] = new Question(5, "When is the object created with new keyword?", "At run time", "At compile time",
				"depends on the code", "None", 'A');
		questions[5] = new Question(6,
		...
		questions[7] = new Question(8, "compareTo() returns", "True", "False", "An int value", "None", 'C');
		questions[8] = new Question(9, "To which of the following does the class string belong to.", "java.lang",
				"ava.awt", "java.applet", "java.string", 'A');
		questions[9] = new Question(10, "Total constructor string class have?", "3", "7", "13", "20", 'C');
